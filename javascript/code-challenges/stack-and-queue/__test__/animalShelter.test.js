...
const { Animal, AnimalShelter } = require('../stack-queue-animal-shelter/index');
...
describe('Animal Shelter Test', () => {
  ...
  test('enqueue should add the animal to the appropriate queue', () => {
    ...
    const cat = new Animal('cat', 'Catty');
  ...
  test('dequeue should return the oldest animal of the preferred type', () => {
    ...
    const dog2 = new Animal('dog', 'Bud');
    const cat1 = new Animal('cat', 'Catty');
    const cat2 = new Animal('cat', 'Kat');
