...
const sortByChildren = (charArray) => {
    charArray.sort((charA, charB) => {
      // Compare the number of children in each house
      ...
      if (numChildrenA < numChildrenB) {
        ...
        // If the number of children is the same, sort alphabetically by house name
...
const containsWorld = (input) => {
  ...
  return regex.test(input.toString().toLowerCase());
};
